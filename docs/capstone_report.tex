...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{API Documentation Tools (Swagger UI)}: Document and interactively test API
  endpoints to keep the surface area transparent for development and integration.
\end{itemize}
...
\begin{enumerate}[label=\textbf{Step \arabic*:}, leftmargin=*]
  ...
  minimum password length of six characters. If any rule fails, descriptive errors
